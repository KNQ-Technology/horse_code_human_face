...
const checkStatus = async () => {
  ...
  try {
    const response = await axios.get(`/api/status?task_id=${taskId.value}`);
  ...
  <div class="app-layout">
    <header class="app-header">
      <div class="header-content">
        ...
        <div class="status-badge" :class="processingStatus">
          <span class="dot"></span>
          {{ statusText }}
        </div>
      </div>
...
.status-badge.uploading .dot { background-color: #3b82f6; box-shadow: 0 0 8px #3b82f6; }
.status-badge.processing .dot { background-color: #8b5cf6; box-shadow: 0 0 8px #8b5cf6; }
.status-badge.completed .dot { background-color: #10b981; box-shadow: 0 0 8px #10b981; }
.status-badge.error .dot { background-color: #ef4444; }
